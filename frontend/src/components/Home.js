        ...
        <div class="col-md-6">
          <div class="card shadow-sm">
            <div class="card-body">
              ...
              <p class="card-text">You can check your details here.</p>
              <a href="/mydata" class="btn btn-outline-primary">My Data</a>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-6">
          <div class="card shadow-sm">
            <div class="card-body">
              ...
              <a href="/vote" class="btn btn-outline-success">Let's Vote</a>
            </div>
          </div>
        </div>
      </div>
